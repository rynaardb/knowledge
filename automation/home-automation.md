...
- [Homebrige](https://homebridge.io) - Bringing HomeKit support where there is none.
- [Hoobs](https://hoobs.org) - A plug and play hub that makes smart accessories compatible with Apple HomeKit, Google Home, and Amazon Alexa. Can also be run on a Raspberry Pi.